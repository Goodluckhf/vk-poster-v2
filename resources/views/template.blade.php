                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="router-link">
                            <a href="#/">
                                <i class="fa fa-hand-grab-o"></i><span>Граббер постов</span>
                            </a>
                        </li>
                        <li class="router-link">
                            <a href="#/gif">
                                <i class="fa fa-hand-grab-o"></i><span>Gif Постер</span>
                            </a>
                        </li>
                        <li class="router-link">
                            <a href="#/likes">
                                <i class="fa fa-heart"></i><span>Авто лайки</span>
                            </a>
                        </li>
                        <li class="router-link">
                            <a href="#/seek">
                                <i class="fa fa-eye"></i><span>Отслеживание группы</span>
                            </a>
                        </li>
                        <li class="router-link">
                            <a href="#/cleaner">
